              ...
              <table class="table table-responsive table-striped table-bordered table_test" style="font-size: 12px;">
                ...
                ?>
                  <tr>
                    ...
                    <td style="width: 125px;"><a href="./edit.php?id=<?php echo $flightId; ?>"><i class="fas fa-pen-square"></i> Edit</a> | <a href="#" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="far fa-trash-alt"></i> Delete</a></td>
